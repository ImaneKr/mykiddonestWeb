...
import CreateGuardianAccount from '@/components/ui/CreateGuardian';
import GuardianList from '@/components/ui/GuardianList'
const Page = () => {
  ...
  return (
    <div className='flex flex-col w-full h-full  items-center'>
      <div className='bg-white mt-1 ml-1 p-3 h-full flex flex-col w-[99%]  rounded-md lg:gap-0 gap-5'>
       <h1 className='inline-block bold-32 '> Guardian accounts management</h1>
       ...
       <div className='w-[98%]  flex justify-between items-center mb-3 mt-2  '>
            ...
            <CreateGuardianAccount  open={open} setOpen={setOpen} />
       </div>
       <div>
        <GuardianList/>
       </div>
