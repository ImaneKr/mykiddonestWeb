              ...
              <div className={`flex flex-col justify-between w-60 h-screen bg-white  z-20 fixed lg:static shadow-inner ${window.innerHeight < 500 ? 'overflow-y-scroll' : ''}`}>
                <div className="flex flex-col justify-start items-start">
                  ...
                  <div className="w-auto   pb-4">
                    {(userRole === 'admin' || userRole === 'secretary') && (<button className=" w-full flex  gap-4 justify-start items-center  px-4   " onClick={() => setIsPressed(1)}>
                    ...
                    {(userRole === 'admin' || userRole === 'secretary') && (<button className=" w-full flex  gap-4 justify-start items-center  px-4 " onClick={() => setIsPressed(6)}>
                    ...
                    {(userRole === 'admin' || userRole === 'secretary') && (<button className=" w-full flex  gap-4 justify-start items-center  px-4   " onClick={() => setIsPressed(7)}>
                ...
                <div className="justify-center items-center ">
                  <img alt="logo" src="/cuteee_animals_3.png" width={70} height={52} className=" lg:w-56 pl-2 w-[95%] " />
                </div>
