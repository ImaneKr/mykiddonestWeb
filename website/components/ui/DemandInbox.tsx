...
const DemandInbox = () => {
    ...
    return (
        <div className=' flex items-center ml-10'>
            ...
            {showInbox && (<div className="absolute z-50 top-10 w-[25%] cursor-pointer right-36 p-4 bg-white shadow-md rounded-md">
                <p className='text-black'>you recived new kids demands</p>
                {demands.map((demand: Demands, index: number) => (
                    <div key={index} className='p-2 m-1 rounded-md shadow-md w-full flex gap-[5%] items-center'
                        ...
                        <img src='/girl.jpg' width={24} height={24} className='rounded-full' />
